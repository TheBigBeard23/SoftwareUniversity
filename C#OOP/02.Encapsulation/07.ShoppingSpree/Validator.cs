...
namespace ShoppingSpree
{
    public class Validator
    {
        ...
        public static void ThrowIfMoneyIsNotEnough(string personName, string productName)
        {
            throw new InvalidOperationException($"{personName} can't afford {productName}");
        }
    }
}
